<template>
  <div class="bg-gray-300 h-screen w-screen flex flex-col justify-center items-center">
    <div class="header">
      ...
      <div class="completed mt-8" v-if="totalCompleted > 0">
        ...
        <ul id="completedList">
          <li
            ...
            :key="index"
            class="text-center text-red-500 p-3 line-through bg-white mt-4 rounded shadow-lg cursor-pointer hover:bg-red-500 hover:text-white"
          >{{completed}}</li>
        </ul>
      </div>
    </div>
